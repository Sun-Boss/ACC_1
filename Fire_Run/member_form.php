...
<script>
   function check_input()
   {
      ...
      if (!document.member_form.snum.value) {
          alert("serial number를 입력하세요!");    
          document.member_form.snum.focus();
          return;
      }
   ...
   function reset_form() {
      ...
      document.member_form.snum.value = "";	
	...
	<section>
          	...
          	<form  name="member_form" method="post" action="member_insert.php">
                ...
                <p>회원정보는 개인정보취급방침에 따라 안전하게 보호되며 회원님의 명백한 동의 없이 공개 또는 제3자에게 제공되지 않습니다.</p>
                    ...
                    <div class="clear"></div>
			       	<div class="form">
				        <div class="col1">serial number</div>
				        <div class="col2">
